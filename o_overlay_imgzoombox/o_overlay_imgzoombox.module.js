...
class O_overlay_imgzoombox{
    ...
    constructor(){
        ...
        this.f_on_mouse_move = function(event){
            ...
            self.o_data.o_mouse.o_position_relative_to_img.n_x = parseInt(window.event.clientX - self.o_data.o_mouse.o_image_bounding_rect.left)
            self.o_data.o_mouse.o_position_relative_to_img.n_y = parseInt(window.event.clientY - self.o_data.o_mouse.o_image_bounding_rect.top)
            ...
            // console.log(self.o_data.o_image.a_s_url_history.indexOf(s_url))
    ...
    f_do_canvas_stuff(){
        ...
        o_img.onload = function(){
            ...
            self.o_data.o_image.n_ratio_width_to_height = this.width / this.height; 
            ...
            if(
                ...
                console.log(self.o_data.o_image.n_factor_normalizing_x, self.o_data.o_image.n_factor_normalizing_y)
            }
            // if(
            //     s_background_size.toLowerCase() == "cover"
            // ){
            //     var n_o_target_bounding_rect = self.o_target.getBoundingClientRect()
            //     var n_o_target_ratio_width_height = n_o_target_bounding_rect.width / n_o_target_bounding_rect.height

            //     if(self.o_data.o_image.n_ratio_width_to_height < 1){
            //         self.o_data.o_image.n_factor_normalizing_y = 1 / self.o_data.o_image.n_ratio_width_to_height
            //     }
            //     if(self.o_data.o_image.n_ratio_width_to_height > 1){
            //         self.o_data.o_image.n_factor_normalizing_x = self.o_data.o_image.n_ratio_width_to_height
            //     }
    ...
    f_calculate_style(){
        var self = this 
        var n_offset_x_perc = self.o_data.o_mouse.o_position_relative_to_img.n_x_normalized*100 * self.o_data.o_image.n_factor_normalizing_x
        var n_offset_y_perc = self.o_data.o_mouse.o_position_relative_to_img.n_y_normalized*100 * self.o_data.o_image.n_factor_normalizing_y
        var self = this
        var s_style_inline =  ""
